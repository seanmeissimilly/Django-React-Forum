    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.TextField(blank=True, default='profile_picture/Isotipo.png', max_length=100, null=True)),
                ('is_staff', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=True)),
                ('role', models.CharField(choices=[('admin', 'Administrador'), ('editor', 'Editor'), ('reader', 'Lector')], default='reader', max_length=10)),
